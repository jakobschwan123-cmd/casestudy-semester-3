...
- **10 BPMN-Kollaborationsdiagramme** (~10 Aktivitäten) → `01-doku-bpmn.md`
- **Use-Case-Diagramm ≥10 Use Cases** → `02-usecase.md`
- **Klassendiagramm ≥10 Klassen** → `03-klassen.md`
- **5 Sequenzdiagramme** → `04-sequenzdiagramme.md`

## Teile
1. [[01-doku-bpmn|Projektdoku + BPMN-Prozessspezifikation (10 Prozesse)]]
2. [[02-usecase|Use-Case-Diagramm (PlantUML)]]
3. [[03-klassen|Klassendiagramm (PlantUML)]]
4. [[04-sequenzdiagramme|5 Sequenzdiagramme (PlantUML)]]
